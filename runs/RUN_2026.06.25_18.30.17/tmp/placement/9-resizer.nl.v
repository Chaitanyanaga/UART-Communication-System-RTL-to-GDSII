module uart_top (clk,
 ...
 sky130_fd_sc_hd__and2_1 _152_ (.A(\bg.baud_tick ),
    .B(\txu.busy ),
    .X(_090_));
 sky130_fd_sc_hd__clkbuf_2 _153_ (.A(_090_),
    .X(_091_));
 ...
 sky130_fd_sc_hd__dfrtp_1 _257_ (.CLK(clk),
    ...
    .RESET_B(_011_),
    .Q(\txu.bit_count[0] ));
 sky130_fd_sc_hd__dfrtp_1 _258_ (.CLK(clk),
    .D(_043_),
    .RESET_B(_012_),
    .Q(\txu.bit_count[1] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _261_ (.CLK(clk),
    ...
    .RESET_B(_015_),
    .Q(net21));
 sky130_fd_sc_hd__dfstp_1 _262_ (.CLK(clk),
    .D(_047_),
    .SET_B(_016_),
    .Q(net20));
 ...
 sky130_fd_sc_hd__dfrtp_1 _270_ (.CLK(clk),
    ...
    .RESET_B(_024_),
    .Q(net18));
 sky130_fd_sc_hd__dfstp_1 _271_ (.CLK(clk),
    .D(_056_),
    .SET_B(_025_),
    .Q(\txu.shift_reg[0] ));
 sky130_fd_sc_hd__dfstp_1 _272_ (.CLK(clk),
    .D(_057_),
    .SET_B(_026_),
    .Q(\txu.shift_reg[1] ));
 sky130_fd_sc_hd__dfstp_1 _273_ (.CLK(clk),
    .D(_058_),
    .SET_B(_027_),
    .Q(\txu.shift_reg[2] ));
 sky130_fd_sc_hd__dfstp_1 _274_ (.CLK(clk),
    .D(_059_),
    .SET_B(_028_),
    .Q(\txu.shift_reg[3] ));
 sky130_fd_sc_hd__dfstp_1 _275_ (.CLK(clk),
    .D(_060_),
    .SET_B(_029_),
    .Q(\txu.shift_reg[4] ));
 sky130_fd_sc_hd__dfstp_1 _276_ (.CLK(clk),
    .D(_061_),
    .SET_B(_030_),
    .Q(\txu.shift_reg[5] ));
 sky130_fd_sc_hd__dfstp_1 _277_ (.CLK(clk),
    .D(_062_),
    .SET_B(_031_),
    .Q(\txu.shift_reg[6] ));
 sky130_fd_sc_hd__dfstp_1 _278_ (.CLK(clk),
    .D(_063_),
    .SET_B(_032_),
    .Q(\txu.shift_reg[7] ));
 sky130_fd_sc_hd__dfstp_1 _279_ (.CLK(clk),
    .D(_064_),
    .SET_B(_033_),
    .Q(\txu.shift_reg[8] ));
 sky130_fd_sc_hd__dfstp_1 _280_ (.CLK(clk),
    .D(_065_),
    .SET_B(_034_),
    .Q(\txu.shift_reg[9] ));
