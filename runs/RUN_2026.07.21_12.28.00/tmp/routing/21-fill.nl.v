module uart_top (clk,
 ...
 sky130_fd_sc_hd__clkbuf_4 _130_ (.A(_074_),
    .X(_076_));
 sky130_fd_sc_hd__nor3_1 _131_ (.A(net24),
    .B(_072_),
    .C(_076_),
    .Y(_005_));
 sky130_fd_sc_hd__a21o_1 _132_ (.A1(net24),
    .A2(_075_),
    .B1(_005_),
    .X(_071_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _203_ (.A(_117_),
    .X(_000_));
 sky130_fd_sc_hd__inv_2 _204_ (.A(net22),
    .Y(_001_));
 ...
 sky130_fd_sc_hd__o21a_1 _210_ (.A1(\bg.count[2] ),
    ...
    .B1(_121_),
    .X(_003_));
 sky130_fd_sc_hd__xor2_1 _211_ (.A(net23),
    .B(_120_),
    .X(_004_));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(\bg.count[0] ),
    .X(net22));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\bg.count[3] ),
    .X(net23));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(\rxu.bit_count[3] ),
    .X(net24));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_4_39 ();
 sky130_fd_sc_hd__decap_4 FILLER_0_4_57 ();
 sky130_fd_sc_hd__fill_2 FILLER_0_4_105 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_5_9 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_5_16 ();
 sky130_fd_sc_hd__decap_4 FILLER_0_5_84 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_12_76 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_14_10 ();
